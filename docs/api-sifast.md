...
|-------|--------|----------|
| List indikator | GET | `/api/sifast/simmutu/indicators` |
| List realisations | GET | `/api/sifast/simmutu/realisations` |
| Input realisation | POST | `/api/sifast/simmutu/realisations` |
| Daily rows (kalender) | GET | `/api/sifast/simmutu/realisations/daily-rows` |
| Stats | GET | `/api/sifast/simmutu/realisations/stats` |
| Detail realisation | GET | `/api/sifast/simmutu/realisations/{id}` |
| Update realisation | PATCH | `/api/sifast/simmutu/realisations/{id}` |
| Hapus realisation | DELETE | `/api/sifast/simmutu/realisations/{id}` |
